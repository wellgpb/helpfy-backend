package com.example.helpfy.exceptions;

public class Constants {
    public static final String USER_NOT_FOUND = "Usuário não encontrado.";
    public static final String USER_ALREADY_EXISTS = "Usuário já cadastrado.";
    public static final String DOES_NOT_EXISTS_USERS = "Ainda não há usuários.";

    public static final String QUESTION_NOT_FOUND = "Questão não encontrada.";
